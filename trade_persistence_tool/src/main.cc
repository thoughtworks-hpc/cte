...
int main(int argc, char* argv[]) {
  ...
  //      config.database_name, config.db_ip, config.db_port,
  //      config.db_username, config.db_password, config.database_table_name);
  ...
  //          CDCF_LOGGER_ERROR("Write db failed, Chunk Database IO Thread
  //          ends"); return;
  //        }
  //      }
  //      last_round_vector_size = trade_manager_db_buffer.size();
